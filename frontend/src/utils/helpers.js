...
export const filterProperties = (properties, filters) => {
  return properties.filter(property => {
    ...
    if (filters.search && filters.search.trim() !== '') {
      ...
      const matchesArea = property.area.toLowerCase().includes(searchTerm);
...
export const sortProperties = (properties, sortBy) => {
  ...
  switch (sortBy) {
    ...
    case 'area-low':
      return sorted.sort((a, b) => (a.carpetArea || a.superArea) - (b.carpetArea || b.superArea));
    case 'area-high':
      return sorted.sort((a, b) => (b.carpetArea || b.superArea) - (a.carpetArea || a.superArea));
    case 'newest':
...
export const shareProperty = (property) => {
  ...
  const text = `Check out this ${property.bhk} BHK in ${property.location}, ${property.area} for ${formatPrice(property.price)}`;
