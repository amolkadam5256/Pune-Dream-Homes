...
const HeaderBottom = () => {
  ...
  const sellSubsections = {
    "For Owner": [
      ...
      {
        label: "Email Us : support@magicbricks.com",
  ...
  const homeLoansSubsections = {
    ...
    Explore: [
      ...
      {
        label: "Get Home Loan Offers NEW",
        link: "/loans/offers",
        badge: "NEW",
      },
      ...
      { label: "Home Loan Interest Rate", link: "/loans/interest-rate" },
      {
        ...
        link: "/loans/balance-transfer-info",
      },
  ...
  const mbAdviceSubsections = {
    "Interior Designers Near You": [
      ...
      {
        label: "Interior Designers Gurgaon",
        link: "/advice/designers/gurgaon",
      },
      {
        label: "Interior Designers Bangalore",
        link: "/advice/designers/bangalore",
      },
      { label: "Interior Designers Pune", link: "/advice/designers/pune" },
      {
        label: "Interior Designers Hyderabad",
        link: "/advice/designers/hyderabad",
      },
      {
        label: "Interior Designers Chennai",
        link: "/advice/designers/chennai",
      },
            ...
            <div className="flex items-center space-x-6">
              {menuItems.map((item, index) => (
                ...
                >
                  ...
                  {item.subsections &&
                    typeof item.subsections === "object" &&
                    !Array.isArray(item.subsections) && (
                      ...
                      >
                        <div className="p-6 grid grid-cols-5 gap-6 max-w-full overflow-x-hidden">
                          {Object.entries(item.subsections).map(
