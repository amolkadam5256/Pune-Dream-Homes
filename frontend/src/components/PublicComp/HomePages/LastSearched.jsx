...
export default function LastSearched() {
    ...
    return (
        <section className="w-full bg-[#fcfdff] py-12">
            <motion.div
            ...
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    ...
                    >
                        <Link to="/buy" className="group relative bg-[var(--color-primary-lightest)] rounded-xl p-6 border border-[var(--color-primary-lightest)] hover:shadow-xl hover:border-[var(--color-primary-light-1)] transition-all duration-300 overflow-hidden block h-full">
                    ...
                    <motion.div
                        ...
                        className="group relative rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 md:col-span-1 border border-[var(--color-primary-lightest)]"
                    >
                        <img
                            src={images.img_11}
                            alt="Modern Interior"
                    ...
                    >
                        <Link to="/projects" className="group bg-white rounded-xl p-6 border border-[var(--color-primary-lightest)] shadow-sm hover:shadow-xl hover:border-[var(--color-primary-light-1)] transition-all duration-300 relative overflow-hidden block h-full">
                    ...
                    >
                        <Link to="/buy" className="group bg-white rounded-xl p-6 border border-[var(--color-primary-lightest)] shadow-sm hover:shadow-xl hover:border-[var(--color-primary-light-1)] transition-all duration-300 relative overflow-hidden block h-full">
                            <div className="absolute -right-4 -top-4 w-24 h-24 bg-[var(--color-primary-lightest)] rounded-full opacity-50 blur-2xl group-hover:bg-[var(--color-primary-light-2)] transition-colors"></div>
