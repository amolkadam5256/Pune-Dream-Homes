        ...
        <section className="w-full py-16 px-4 bg-white border-t border-[var(--color-primary-lightest)]">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    {/* Directory Card */}
                    <div className="group bg-white border border-[var(--color-primary-lightest)] rounded-2xl p-8 text-center hover:shadow-2xl hover:border-[var(--color-primary-light-1)] transition-all duration-300">
                ...
                {/* CTA Button */}
                <button className="bg-[var(--color-primary)] hover:bg-[var(--color-primary-dark-1)] text-white font-bold py-4 px-10 rounded-xl text-xs uppercase tracking-widest transition-all shadow-lg hover:shadow-xl active:scale-95">
